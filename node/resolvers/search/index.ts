...
export const queries = {
  ...
  facets: async (_: any, args: FacetsInput, ctx: any) => {
    ...
    return {
      facets: attributesToFilters({ breadcrumb, total: intelligentSearchFacets.total, attributes: attributesWithVisibilitySet, solrFacets, selectedFacets: args.selectedFacets }),
      queryArgs: {
        map: args.map,
        query: args.query,
